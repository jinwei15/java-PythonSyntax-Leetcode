...
public class ArrayPartitionI {
	 ...
	 *            min(1, 2) + min(3, 4). Note: n is a positive integer, which is in
	 *            the range of [1, 10000]. All the integers in the array will be in
	 *            the range of [-10000, 10000].
	 * 
	 */
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		SolutionArrayPartitionI so = new SolutionArrayPartitionI();
		int [] aa = new int[] {1,4,3,2}; 
		System.out.println(so.arrayPairSum(aa));
