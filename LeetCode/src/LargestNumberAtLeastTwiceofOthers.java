...
public class LargestNumberAtLeastTwiceofOthers {
	 ...
	 *            Example 2:
	 * 
	 *            Input: nums = [1, 2, 3, 4] Output: -1 Explanation: 4 isn't at
	 *            least as big as twice the value of 3, so we return -1.
	 * 
	 * 
	 *            Note:
	 * 
	 *            nums will have a length in the range [1, 50]. Every nums[i] will
	 *            be an integer in the range [0, 99].
	 */
...
class SolutionLargestNumberAtLeastTwiceofOthers {
