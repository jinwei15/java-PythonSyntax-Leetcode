...
Question + link + most intuitive thought about this question. You can find the answer under [LeetCode/src](https://github.com/jinwei14/java-PythonSyntax-Leetcode/tree/master/LeetCode/src) 面试都是有套路的，刷的题也是，套路多多. 基本套路Array, two pointer, hashmap，tree（BFS DFS), in order, post order traversal, math, MinMaxHeap
